...
class UpdateTrade(val linearId: UniqueIdentifier) : FlowLogic<SignedTransaction>() {
    ...
    override fun call(): SignedTransaction {
       ...
       // val criteria = QueryCriteria.LinearStateQueryCriteria(null, listOf(linearId),status = Vault.StateStatus.UNCONSUMED)
        ...
        val command = Command(IOUContract.Update(), listOf(inputState.from.owningKey, inputState.to.owningKey))
